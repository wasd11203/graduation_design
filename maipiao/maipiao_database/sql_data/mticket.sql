...
-- ----------------------------
INSERT INTO `association_order_resource` VALUES ('1029053142', '1', '1', '1', '1', '1', '2', '100');
...
-- ----------------------------
INSERT INTO `association_user_order` VALUES ('1', '1029053142');

-- ----------------------------
-- Table structure for `association_user_receiveaddresses`
-- ----------------------------
...
-- ----------------------------
-- Records of association_user_receiveaddresses
-- ----------------------------
...
-- ----------------------------
INSERT INTO `discount_resource` VALUES ('1');
INSERT INTO `discount_resource` VALUES ('2');
...
-- ----------------------------
INSERT INTO `hot_sell_resource` VALUES ('3');

-- ----------------------------
-- Table structure for `near_hot_resource`
-- ----------------------------
DROP TABLE IF EXISTS `near_hot_resource`;
CREATE TABLE `near_hot_resource` (
  `RESOURCE_ID` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of near_hot_resource
-- ----------------------------
INSERT INTO `near_hot_resource` VALUES ('1');
INSERT INTO `near_hot_resource` VALUES ('2');
...
-- ----------------------------
INSERT INTO `order_base_info` VALUES ('1029053142', '1', '1', '100', '123465778', '浙江', '杭州', '西湖', 'aa', 'bb', '1234657', null, '2017-04-05 16:58:25', '1');
...
-- ----------------------------
INSERT INTO `resource_advertising` VALUES ('1', 'www.baidu.com', null, '1');
INSERT INTO `resource_advertising` VALUES ('2', 'www.baidu.com', null, '1');
INSERT INTO `resource_advertising` VALUES ('3', 'www.baidu.com', null, '0');
...
-- ----------------------------
INSERT INTO `resource_info` VALUES ('1', 'Priscilla Ahn 普莉西亚 “LALALA 啦啦啦”2017巡回演唱会', 'a', '暖心专辑《La La La》', 'b', '1', '1001');
INSERT INTO `resource_info` VALUES ('2', '华艺星空.我只在乎你-邓丽君经典金曲七夕演唱会', null, '让我们一同向经典致敬', null, '1', '1001');
INSERT INTO `resource_info` VALUES ('3', 'Radio Attack电音派对', null, '探寻音符深处最原始的欲望', null, '1', '1002');
INSERT INTO `resource_info` VALUES ('4', '郑钧2017“私奔”全国巡回演唱会北京站', null, '摇滚男神 温情回归', null, '1', '1003');
INSERT INTO `resource_info` VALUES ('5', '汪峰2017岁月巡回演唱会-北京鸟巢站', null, '在时间里记录行走的脚步', null, '1', '1005');
INSERT INTO `resource_info` VALUES ('6', '“悠春小叙”小娟＆山谷里的居民2017北京演唱会', null, '小娟&山谷里的居民4月北京开唱', null, '1', '1005');
INSERT INTO `resource_info` VALUES ('7', '澳大利亚海德堡合唱团--歌剧与音乐剧经典唱段音乐会', null, '用合唱演绎经典歌剧音乐剧选段', null, '1', '1006');
INSERT INTO `resource_info` VALUES ('8', '北京文化艺术基金2016年度资助项目 北京央华出品舞台剧《新原野》', null, '中国女性的世纪生命史诗', null, '1', '2001');
...
-- ----------------------------
INSERT INTO `showvenue_info` VALUES ('1', null, '世纪剧院', '亮马桥路40号', '010-64628470', null, '1');
INSERT INTO `showvenue_info` VALUES ('2', null, '京演民族文化宫大剧院', '复兴门内大街49号 ', '010-83195318', null, '1');
INSERT INTO `showvenue_info` VALUES ('3', null, '格瓦拉生活·糖果Live', '和平西街79号 雍和宫桥路北50米', '010-64255677;010-64255677', null, '1');
INSERT INTO `showvenue_info` VALUES ('4', null, '北京首都体育馆', '西直门外白石桥5号', '010-88318421;010-68350077', null, '1');
INSERT INTO `showvenue_info` VALUES ('5', null, '国家体育场(鸟巢)', '国家体育场西路1号', '4001100100;4001100100', null, '1');
INSERT INTO `showvenue_info` VALUES ('6', null, '北京展览馆剧场', '西直门外大街135号北京展览馆内', '010-68354455', null, '1');
INSERT INTO `showvenue_info` VALUES ('7', null, '北京音乐厅', '北新华街1号(西长安街六部口西南角)', '010-66057006;010-66055812', null, '1');
INSERT INTO `showvenue_info` VALUES ('8', null, '北京保利剧院', '东直门南大街14号保利大厦', '010-65065345', null, '1');
...
-- ----------------------------
INSERT INTO `site_info` VALUES ('1', null, '2017-05-13 19:30:00', '6', '1');
...
-- ----------------------------
INSERT INTO `ticket_info` VALUES ('1', null, '8', '100', null, null);
...
-- ----------------------------
INSERT INTO `user_base_info` VALUES ('1', null, 'wasd11203', '123456', '1995-08-12 09:51:30', '1', null);
