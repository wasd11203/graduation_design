...
public class SearchResourceController {
	...
	public JSONObject searchResourceByMark(String keywords,String regionThirdId,String resourceTopId,
											String resourceSecId,String resourceThirdId,String minTime,
											String maxTime){
		JSONObject jobj = new JSONObject();
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		
		Integer resourceTop = null;
		Map<String, Object> map = transfoArgs(regionThirdId, resourceSecId, resourceThirdId, minTime, maxTime, sdf);
	...
	private Map<String, Object> transfoArgs(String regionThirdId, String resourceSecId, String resourceThirdId,
